      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-4 gap-2 m-4 w-full max-w-4xl mx-auto">
        {
          dummyTrailers.map((trailer) => (
            <div
              key={trailer.image}
              className="relative aspect-video flex justify-center items-center group cursor-pointer transform transition-transform duration-300 ease-in hover:-translate-y-1"
            >
